...
/**
 * Abstract class to represent a SimpleTowns command.
...
public abstract class SimpleTownsCommand {
     ...
     */
    abstract public boolean execute(SimpleTowns plugin, CommandSender sender, String commandLabel, String[] args);
