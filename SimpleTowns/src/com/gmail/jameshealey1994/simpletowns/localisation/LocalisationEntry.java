...
public enum LocalisationEntry {
    ...
    ERR_SPECIFY_TOWN (
            "MsgSpecifyTown",
            null,
            "&cPlease specify a town"),

    /**
     * Message telling user to specify a valid town name.
     */
    ERR_SPECIFY_TOWN_NAME (
            "MsgSpecifyTownName",
            null,
            "&cPlease specify a town name"),

    /**
     * Message telling user that town names must be a single word.
     */
    ERR_TOWN_NAMES_MUST_BE_A_SINGLE_WORD (
            "MsgTownNamesMustBeASingleWorld",
            null,
            "&cTown names must be a single word"),
     ...
     * %2$s - town name
     */
    ERR_PLAYER_ALREADY_MEMBER (
            "MsgPlayerAlreadyMember",
            "%1$s - player name\n# %2$s - town name",
            "&cPlayer '%1$s' is already a member of Town '%2$s'"),
     ...
     * %2$s - town name
     */
    ERR_PLAYER_ALREADY_LEADER (
            "MsgPlayerAlreadyLeader",
            "%1$s - player name\n# %2$s - town name",
            "&cPlayer '%1$s' is already a leader in Town '%2$s'"),
     ...
     * %2$s - town name
     */
    ERR_PLAYER_ALREADY_CITIZEN (
            "MsgPlayerAlreadyCitizen",
            "%1$s - player name\n# %2$s - town name",
            "&cPlayer '%1$s' is already a citizen in Town '%2$s'"),
    ...
    ERR_NOT_LEADER (
            "MsgNotLeader",
            "%1$s - town name",
            "&cPermission denied - You are not a town leader in '%1$s'"),
     ...
     * %2$s - town name
     */
    ERR_PLAYER_NOT_MEMBER (
            "MsgPlayerNotMember",
            "%1$s - player name\n# %2$s - town name",
            "&cPlayer '%1$s' is not a member of Town '%2$s'"),
    ...
    LOG_TOWN_RENAMED (
            "LogTownRenamed",
            "%1$s - old town name\n# %2$s - new town name\n# %3$s - sender name",
            "Town '%1$s' renamed to '%2$s' by '%3$s'"),
     ...
     * %3$s - player name
     */
    LOG_TOWN_LEADER_ADDED (
            "LogTownLeaderAdded",
            "%1$s - town name\n# %2$s - leader name\n# %3$s - player name",
            "Player '%2$s' added as Leader to Town '%1$s' by '%3$s'"),
    ...
    LOG_CHUNK_CLAIMED (
            "LogChunkClaimed",
            "%1$s - town name\n# %2$s - player name\n# %3$s - world name\n# %4$s - chunk X\n# %5$s - chunk Z",
            "Chunk (%4$s, %5$s) in World '%3$s' claimed for Town '%1$s' by Player '%2$s'"),
    ...
    LOG_CHUNK_UNCLAIMED (
            "LogChunkUnclaimed",
            "%1$s - town name\n# %2$s - player name\n# %3$s - world name\n# %4$s - chunk X\n# %5$s - chunk Z",
            "Chunk (%4$s, %5$s) in World '%3$s' unclaimed from Town '%1$s' by Player '%2$s'"),
     ...
     * %3$s - citizen name
     */
    LOG_CITIZEN_PROMOTED (
            "LogCitizenPromoted",
            "%1$s - town name\n# %2$s - sender name\n# %3$s - citizen name",
            "Citizen '%3$s' promoted to Leader in Town '%1$s' by '%2$s'"),
    ...
    LOG_LEADER_DEMOTED (
            "LogLeaderDemoted",
            "%1$s - town name\n# %2$s - sender name\n# %3$s - leader name",
            "Leader '%3$s' demoted to Citizen in Town '%1$s' by '%2$s'"),
     ...
     * %3$s - member name
     */
    LOG_TOWN_MEMBER_REMOVED (
            "LogTownMemberRemoved",
            "%1$s - town name\n# %2$s - sender name\n# %3$s - member name",
            "Player '%3$s' removed from Town '%1$s' by '%2$s'"),
    ...
    MSG_MEMBER_REMOVED (
            "MsgMemberRemoved",
            "%1$s - town name\n# %2$s - member name",
            "&7Player '%2$s' removed from Town '%1$s'"),
    ...
    MSG_REMOVED_MEMBER (
            "MsgRemovedMember",
            "%1$s - town name\n# %2$s - sender name",
            "&7You have been removed from Town '%1$s' by '%2$s'"),
    ...
    MSG_CITIZEN_ADDED (
            "MsgCitizenAdded",
            "%1$s - town name\n# %2$s - citizen name",
            "&7Added Player '%2$s' to Town '%1$s' as a Citizen"),
     ...
     * %2$s - sender name
     */
    MSG_ADDED_AS_CITIZEN (
            "MsgAddedAsCitizen",
            "%1$s - town name\n# %2$s - sender name",
            "&7You were added to Town '%1$s' as a Citizen by '%2$s'"),
     ...
     * %2$s - citizen name
     */
    MSG_CITIZEN_PROMOTED (
            "MsgCitizenPromoted",
            "%1$s - town name\n# %2$s - citizen name",
            "&7Promoted Player '%2$s' to Leader in Town '%1$s'"),
    ...
    MSG_PROMOTED (
            "MsgPromoted",
            "%1$s - town name\n# %2$s - sender name",
            "&7You were promoted to Leader in Town '%1$s' by '%2$s'"),
    ...
    MSG_LEADER_DEMOTED (
            "MsgLeaderDemoted",
            "%1$s - town name\n# %2$s - leader name",
            "&7Demoted Player '%2$s' to Citizen in Town '%1$s'"),
    ...
    MSG_DEMOTED (
            "MsgDemoted",
            "%1$s - town name\n# %2$s - sender name",
            "&7You were demoted to Citizen in Town '%1$s' by '%2$s'"),
    ...
    MSG_CHUNK_UNCLAIMED (
            "MsgChunkUnClaimed",
            "%1$s - town name",
            "&7Chunk unclaimed! No longer owned by Town '%1$s'"),
    ...
    */
    ...
    MSG_TOWN_CREATED (
            "MsgTownCreated",
            "%1$s - town name",
            "&6Congratulations, you created Town '%1$s'!"),
     ...
     * %1$s - town name
     */
    MSG_ONLY_TOWN_MEMBERS_CAN_BREAK_BLOCKS (
            "MsgOnlyTownMembersCanBreakBlocks",
            "%1$s - town name",
            "&cOnly members of Town '%1$s' can break blocks here"),
     ...
     * %1$s - town name
     */
    MSG_ONLY_TOWN_MEMBERS_CAN_PLACE_BLOCKS (
            "MsgOnlyTownMembersCanPlaceBlocks",
            "%1$s - town name",
     ...
     * %1$s - town name
     */
    MSG_TOWN_CREATED_BROADCAST (
            "MsgTownCreatedBroadcast",
            "%1$s - town name",
            "&6New Town '%1$s' created!"),
     ...
     * %1$s - town name
     */
    MSG_TOWN_DELETED_BROADCAST (
            "MsgTownDeletedBroadcast",
            "%1$s - town name",
            "&6Town '%1$s' deleted"),
    ...
    DESCRIPTION_CREATE (
            "DescCreate",
            null,
            "Creates a town with current chunk"),
    ...
    DESCRIPTION_UNCLAIM (
            "DescUnclaim",
            null,
            "Removes a town's claim to a chunk"),
    ...
    DESCRIPTION_PROMOTE (
            "DescPromote",
            null,
            "Promotes a citizen to a leader in a town"),
    ...
    DESCRIPTION_DEMOTE (
            "DescDemote",
            null,
            "Demotes a leader to a citizen in a town"),
     ...
     * %1$s - leader name
     */
    INFO_TOWN_LEADERS_ENTRY (
            "InfoTownLeadersEntry",
            "%1$s - leader name",
            "&d - %1$s"),
     ...
     * %1$s - citizen name
     */
    INFO_TOWN_CITIZENS_ENTRY (
            "InfoTownCitizensEntry",
            "%1$s - citizen name",
            "&d - %1$s"),
